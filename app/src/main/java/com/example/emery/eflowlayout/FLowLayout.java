    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY && heightMode == MeasureSpec.EXACTLY) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                /*measureChildWithMargins(childView,widthMeasureSpec,childWidth,heightMeasureSpec,childHeight);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < linesView.size(); i++) {
            ...
            for (int j = 0; j < views.size(); j++) {
                ...
                //第一个摆放完成
                currentLeft+=childView.getMeasuredWidth()+marginLayoutParams.rightMargin+marginLayoutParams.leftMargin;
            }
            //换行
            currentLeft=0;
